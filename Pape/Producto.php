...
<body>
    <header>
        ...
        <td colspan="3" align="center" class="pp">
            <label>Introducción de productos<br>Papeleria el Estudiante</label>
            </td>
  ...
  <ul class="dropdown-menu">
    ...
    <form method="post" action="intProd.php" enctype="multipart/form-data">
        
    <label for="producto">Producto</label><br>
    <input type="text" name="producto"  class="disp2" required><br><br>
        
    <label for="catalogos">Catálogos</label><br>
    <select name="catalogos" placeholder="Catálogos" required class="disp2">
    ...
    <input type="number" name="cantidad" required class="disp2"><br><br>
        
    <label for="marca">Marca</label><br>
    <input type="text" name="marca" required class="disp2"><br><br>
        
    <label for="price">Precio</label><br>
    <input type="number" name="price" required class="disp2"><br><br>
        
    <label for="imgn">Insertar imagén</label><br>
    <input type="file" name="imgn" required class="disp2"><br><br>
        
    <label for="info">Información</label><br>
    <textarea name="info" class="int" placeholder="Info del producto" maxlength="200"></textarea><br>
        <button type="reset">Reiniciar Datos</button>
