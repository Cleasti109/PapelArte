...
$productos = buscarProducto($conexion, $prod, $cata);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <header>
        <table width="2000px">
            <td width="200px">
                <a href="main.php"><img src="estilo/pape.png" alt="Foto de perfil" width="50px" height="50px" class="imgs" id="imgse"></a></td>
        ...
        <td colspan="3" align="center" class="pp">
            ...
            <input type="text" value="<?php echo $prod; ?>" placeholder="Buscar producto..." name="prod" class="search">
...
<?php     }else{?>
    ...
    <table>
                <h1 align="center">Resultados</h1><hr>
            <?php
    $i=0;
